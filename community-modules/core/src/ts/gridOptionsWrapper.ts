...
import { ChartToolPanelOverrides } from './interfaces/iChartOptions';
...
export class GridOptionsWrapper {
    ...
    */
    ...
    public getChartToolPanelOverrides(): ChartToolPanelOverrides | undefined {
        return this.gridOptions.chartToolPanelOverrides;
    }
